...
def create_filled_customers_table():
    ...
    cursor.execute("INSERT INTO Customers VALUES(?,?,?,?,?);", (0, None, None, None, None))     # Creates Guest Customer Profile
    ...
    cursor.execute('INSERT INTO Customers VALUES(?,?,?,?,?);', (largest_customer_id + 1, 'Reid','Moline', None, 4032737373))    # Before you try to call this number note it is for Pizza 73
